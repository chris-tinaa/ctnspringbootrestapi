...
public class SwaggerConfig {
    ...
    public Docket api(){
        return new Docket(DocumentationType.SWAGGER_2).
                select().
                apis(RequestHandlerSelectors.basePackage("com.juaracoding.cspringbootrestapi.controller")).
...
//    String licenseUrl) {
    private ApiInfo apiInfo()
    {
        ApiInfo apiInfo = new ApiInfo(
                ...
                new Contact("Christina","localhost:8080/api/v1","chrislinlin.cl@gmail.com"),//Contact Name

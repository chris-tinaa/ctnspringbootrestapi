...
import com.juaracoding.cspringbootrestapi.dto.BarangDTO;
import com.juaracoding.cspringbootrestapi.dto.KategoriBarangDTO;
...
import com.juaracoding.cspringbootrestapi.repo.BarangRepo;
...
//            (barangTrans.getKategoriBarang()!=null || !barangTrans.getKategoriBarang().equals(""))?barangTrans.setKategoriBarang(barang.getKategoriBarang()):barangTrans.setKategoriBarang(barangTrans.setKategoriBarang());
    ...
    public ResponseEntity<Object> findById(Long id, HttpServletRequest request) {
        ...
        try{
            ...
            barangDTO = modelMapper.map(barangTrans, new TypeToken<BarangDTO>() {}.getType());
    ...
    public ResponseEntity<Object> findAllByPage(Integer page, Integer size, HttpServletRequest request) {
        ...
        try
        {
            ...
            listBarangDTO = modelMapper.map(pageBarang.getContent(), new TypeToken<List<KategoriBarangDTO>>() {}.getType());
